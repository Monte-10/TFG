            ...
            <div className="row">
                <div className="col-md-4">
                    ...
                    <ul>
                        ...
                        <li><Link to="/nutrition/adapt-diet-or-option">Adaptar Dieta u Opción</Link></li>
                    </ul>
                </div>
                <div className="col-md-4">
                    <h3>Deporte</h3>
                ...
                <div className="col-md-4">
                    <h3>Entrenadores</h3>
                    <ul>
                        <li><Link to="/search-trainer">Buscar Entrenador</Link></li>
                        <li><Link to="/trainers">Listar Entrenadores</Link></li>
                    </ul>
                </div>
            </div>
        </div>
