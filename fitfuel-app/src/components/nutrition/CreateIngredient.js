...
function CreateIngredient() {
  ...
  return (
    <div className="container mt-4">
        ...
        <div className="mb-3">
          <label htmlFor="filterMinSaturatedFat" className="form-label">Mínimo de Grasas Saturadas</label>
          <input
            type="number"
            className="form-control"
            id="filterMinSaturatedFat"
            value={filters.minSaturatedFat.value}
            onChange={e => handleFilterChange('minSaturatedFat', e.target.value)}
          />
        </div>

        <div className="mb-3">
          <label htmlFor="filterMaxSaturatedFat" className="form-label">Máximo de Grasas Saturadas</label>
          <input
            type="number"
            className="form-control"
            id="filterMaxSaturatedFat"
            value={filters.maxSaturatedFat.value}
            onChange={e => handleFilterChange('maxSaturatedFat', e.target.value)}
          />
        </div>
        ...
        <div className="card mt-4">
          ...
          <ul className="list-group list-group-flush">
            ...
            <li className="list-group-item">Contains Fish/Shellfish/Canned/Preserved: {nutritionalInfo.contains_fish_shellfish_canned_preserved ? 'Sí' : 'No'}</li>
