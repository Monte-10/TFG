...
class DiaDeDieta(models.Model):
    ...
    total_proteina = models.FloatField(null=True, blank=True)
    total_hc = models.FloatField(null=True, blank=True)
    total_azucar = models.FloatField(null=True, blank=True)
    total_fibra = models.FloatField(null=True, blank=True)
    total_grasa = models.FloatField(null=True, blank=True)
    total_grasa_sat = models.FloatField(null=True, blank=True)
    total_apto_celiacos = models.BooleanField(default=False)
    total_apto_lactosa = models.BooleanField(default=False)
    total_apto_veganos = models.BooleanField(default=False)
    total_apto_vegetarianos = models.BooleanField(default=False)
    total_apto_pescetarianos = models.BooleanField(default=False)
    total_carne = models.BooleanField(default=False)
    total_verdura = models.BooleanField(default=False)
    total_pescado_marisco_enlatado_conserva = models.BooleanField(default=False)
    total_cereal = models.BooleanField(default=False)
    total_pasta_arroz = models.BooleanField(default=False)
    total_lacteo_yogur_queso = models.BooleanField(default=False)
    total_fruta = models.BooleanField(default=False)
    total_fruto_seco = models.BooleanField(default=False)
    total_legumbre = models.BooleanField(default=False)
    total_salsa_condimento = models.BooleanField(default=False)
    total_fiambre = models.BooleanField(default=False)
    total_pan_panMolde_tostada = models.BooleanField(default=False)
    total_huevo = models.BooleanField(default=False)
    total_suplemento_bebida_especial = models.BooleanField(default=False)
    total_tuberculo = models.BooleanField(default=False)
    total_otros = models.BooleanField(default=False)
...
class Dieta(models.Model):
    ...
    goal = models.TextField(null=True, blank=True)
    cliente = models.ForeignKey(CustomUser, on_delete=models.CASCADE, null=True, blank=True, related_name='dietas')
    dias = models.ManyToManyField(DiaDeDieta, through='DietaDia')
'''