...
\title{Plataforma para la Gestión Nutricional y Deportiva}
...
\chapter{Desarrollo\label{CAP:ELEMINT}}{elemint/elemint}
  \section{Back-End\label{SEC:FIGURAS}}{elemint/figuras}
    ...
    \subsection{Base de Datos\label{SS:IMAGENES}}{elemint/imagenes}
...
\chapter{Acceso e instalación\label{CAP:WORDLATEX}}{varios/wordlatex}
\chapter{Dependencias y librerías\label{CAP:INSTALACION}}{varios/instalacion}
\chapter{Requisitos e incrementos\label{CAP:PAQUETES}}{varios/paquetes}
