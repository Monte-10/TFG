...
Figura \ref{FIG:basedatos} muestra un diagrama de la estructura general de la base de datos de FitFuelBalance, que ilustra las relaciones entre las tablas principales y sus propiedades.
