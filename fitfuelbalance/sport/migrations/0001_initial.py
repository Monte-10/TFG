# Generated by Django 4.2.6 on 2024-01-30 18:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dishes', models.ManyToManyField(to='sport.dish')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sport.food')),
            ],
        ),
        migrations.AddField(
            model_name='dish',
            name='ingredients',
            field=models.ManyToManyField(to='sport.ingredient'),
        ),
        migrations.AddField(
            model_name='dish',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField()),
                ('diet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sport.diet')),
                ('meals', models.ManyToManyField(to='sport.meal')),
            ],
            options={
